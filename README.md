# SILVER GARAGE ADVENT · CAFE RACER

銀の膜をコインで削り、息を吹きかけてカスを払い、現れた一台をコレクションする。毎日一枚ずつ楽しむ、架空のCAFE RACERのスクラッチカードです。

全31枚。少しだけ削っても、「コレクションにしまう」と残りの銀が自然に剥がれます。写真は事前にAIで生成しており、遊ぶときにAIやAPIキーは必要ありません。

[OPEN APP](https://masato-nasu.github.io/SILVER-GARAGE-ADVENT-CAFE-RACER/)

![CAFE RACER](assets/cafe-racer/day-01.webp)
